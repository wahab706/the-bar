...
const productVariantsData = [
  {
    ...
    sku: "BPN3963ydd32",
    image:
      "https://cdn.shopify.com/s/files/1/0136/5223/0203/products/black.jpg?v=1667398012",
  },
  {
    id: "2",
    product: "Dance of the devil",
    ...
    sku: "BPN3535ydd32",
    image:
      "https://cdn.shopify.com/s/files/1/0136/5223/0203/products/white.jpg?v=1667398096",
  },
  {
    id: "3",
    product: "Dance of the devil",
    ...
    sku: "BPN39797h336",
    image:
      "https://cdn.shopify.com/s/files/1/0136/5223/0203/products/blue.jpg?v=1667398487",
  },
  {
    id: "4",
    product: "Dance of the devil",
    ...
    sku: "BPN34653gr64",
    image:
      "https://cdn.shopify.com/s/files/1/0136/5223/0203/products/red.jpg?v=1667398168",
  },
  {
    id: "5",
    product: "Dance of the devil",
...
export function OrderDetail() {
  ...
  const { selectedResources, allResourcesSelected, handleSelectionChange } =
    useIndexResourceState(productVariantsData);
  ...
  const handleSalesChannelModal = useCallback(
    () => setSalesChannelModal(!salesChannelModal),
    [salesChannelModal]
  );

  const salesChannelContentMarkup =
    salesChannelSelected.length > 0 ? (
  ...
  const handleProductDescriptionChange = useCallback(
    (newValue) => setProductDescription(newValue),
    []
  );
        ...
        <IndexTable.Cell>
          <div className="Variants-Button-Group">
            <ButtonGroup segmented>
              <Button size="slim" className="Variants-Edit-Button">
                Edit
              </Button>
              <Button size="slim">
        ...
        <Layout>
          <Layout.Section>
            ...
            >
              ...
              <p className="Product-Seo-Url">
                {" "}
                https://ilt2-development.myshopify.com/products/dance-with-the-devil-5
              </p>
              <p className="Product-Seo-Description">
                Available In Black. Elastic Waistband Drawstring Side Hand
                Pockets Disclaimer: Due To The Printing Process A Difference In
                Saturation May Occur. Each Garment Is Unique 60% Cotton 40%
                Polyester Imported
              </p>
            </Card>
          </Layout.Section>
...
function TwitterIcon() {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M14.362 3.737c.01.14.01.282.01.424 0 4.338-3.302 9.34-9.34 9.34v-.003A9.293 9.293 0 0 1 0 12.027a6.591 6.591 0 0 0 4.858-1.36 3.287 3.287 0 0 1-3.067-2.28c.492.095 1 .075 1.482-.057A3.283 3.283 0 0 1 .64 5.113V5.07c.457.254.967.395 1.49.41A3.287 3.287 0 0 1 1.114 1.1a9.317 9.317 0 0 0 6.765 3.43 3.285 3.285 0 0 1 5.594-2.995 6.587 6.587 0 0 0 2.085-.797 3.295 3.295 0 0 1-1.443 1.816A6.529 6.529 0 0 0 16 2.036a6.669 6.669 0 0 1-1.638 1.7Z"></path>
    </svg>
  );
}
...
function RedditIcon() {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M9.492 10.232a.144.144 0 0 1 0 .204c-.31.308-.796.458-1.487.458l-.006-.001-.005.001c-.69 0-1.177-.15-1.487-.459a.143.143 0 0 1 0-.203.146.146 0 0 1 .204 0c.253.251.672.374 1.283.374l.005.001.006-.001c.61 0 1.029-.123 1.282-.374a.146.146 0 0 1 .205 0ZM7.199 8.62a.614.614 0 0 0-1.23 0 .614.614 0 0 0 1.23 0ZM16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0Zm-3.333-.086a1.032 1.032 0 0 0-1.75-.739c-.704-.463-1.656-.758-2.71-.796l.576-1.816 1.562.366-.002.023a.844.844 0 0 0 1.69 0 .844.844 0 0 0-1.63-.305l-1.684-.395a.144.144 0 0 0-.171.097l-.643 2.025c-1.104.013-2.104.31-2.839.787a1.03 1.03 0 0 0-1.733.753c0 .377.208.704.512.883-.02.11-.033.221-.033.334 0 1.52 1.87 2.758 4.169 2.758 2.298 0 4.168-1.238 4.168-2.758a1.83 1.83 0 0 0-.029-.315c.324-.174.547-.51.547-.902Zm-3.248.094a.614.614 0 0 0-.615.613.614.614 0 0 0 1.23 0 .614.614 0 0 0-.615-.613Z"></path>
    </svg>
  );
}
...
function CheckoutLink() {
  return (
    <img
      src="https://cdn.shopify.com/s/files/applications/5076396ac61bba417a451577630ddc08_80x.png?1624291018"
      alt="checkout"
    />
  );
}
...
function RunflowAutomation() {
  return (
    <img
      src="https://cdn.shopify.com/s/files/applications/15100ebca4d221b650a7671125cd1444_80x.png?1661466254"
      alt="automation"
    />
  );
}
